...
$B.$search = function(name, global_ns){
    ...
    if(frame[0] !== '__main__' && frame[1][name]!==undefined){return frame[1][name]}
    else if(frame[0] !== '__main__' && frame[3][name]!==undefined){return frame[3][name]}
