...
const loadAllSessions = function(sessionIndex) {
    const SESSIONS = JSON.parse(localStorage.getItem('SESSIONS')) || [];
...
const saveSession = function({sessionName, sessionIndex}) {
    let SESSIONS = JSON.parse(localStorage.getItem('SESSIONS')) || [];
    const code = editor.getValue();
    if (sessionName) {
        SESSIONS.push({code, name: sessionName});
